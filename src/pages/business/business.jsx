                ...
                <div className="flex justify-around mb-20 flex-wrap ">
                    ...
                    <div className=" our w-[380px] pt-[95px] border-2  mb-20 border-[#EFEFEF] rounded-lg overflow-visible relative shadow"
                        ...
                        <div className="p-4   text-left">
                            <p className="text-2xl font-semibold mb-2">Enterprise Architecture Analysis</p>
                            <p className="text-lg text-[#797979] mb-2">We offer a business-focused strategy for Enterprise Architecture, guaranteeing that your IT investments are guided by your strategic business goals, leading to optimal ROI.</p>
                        </div>
                    </div>
                    ...
                    <div className="our w-[380px] pt-[95px] border-2  mb-20 border-[#EFEFEF] rounded-lg overflow-visible relative shadow"
                        ...
                        <div className="p-4   text-left">
                            <p className="text-2xl font-semibold mb-2">Requirements Management</p>
                            <p className="text-lg text-[#797979]  mb-2">We provide a robust requirements management service that establishes a reliable and repeatable process, ensuring business agility, and software success.</p>
                        </div>
                    </div>
                    ...
                    <div className="our w-[380px] pt-[95px] border-2  mb-20 border-[#EFEFEF] rounded-lg overflow-visible relative shadow"
                        ...
                        <div className="p-4   text-left ">
                            <p className="text-2xl font-semibold mb-2">Mapping Value Streams and Customer Journeys</p>
                            <p className="text-lg text-[#797979]  mb-2">We analyze the value streams, including people, processes, and technologies, along with understanding the customer experience, empowers informed decisions for enhancing products and services.</p>
                        </div>
                    </div>
                    ...
                    <div className="our w-[380px] pt-[95px] mt-4 border-2  mb-20 border-[#EFEFEF] rounded-lg overflow-visible relative shadow"
                        ...
                        <div className="p-4   text-left">
                            <p className="text-2xl font-semibold mb-2">Business Process Improvement</p>
                            <p className="text-lg text-[#797979]  mb-2">We analyze and evaluate current practices, redesigning processes, and implementing changes to achieve Process improvement.</p>
                        </div>
                    </div>
                    ...
                    <div className="our w-[380px] pt-[95px] mt-4 border-2  mb-20 border-[#EFEFEF] rounded-lg overflow-visible relative shadow"
                        ...
                        <div className="p-4   text-left">
                            <p className="text-2xl font-semibold mb-2">Digital Transformation Strategies</p>
                            <p className="text-lg text-[#797979]  mb-2">Our comprehensive suite of services is crafted to revolutionize your operations, enhance customer experiences, and drive sustainable growth in the rapidly evolving digital landscape.</p>
                        </div>
                    </div>
