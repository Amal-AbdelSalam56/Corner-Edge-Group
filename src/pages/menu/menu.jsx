    ...
    return (
        <>
            <div className="relative">
                {/* Image */}
                <img src={Banner0} alt="Your Image" className="w-full h-auto" />

                {/* Button */}
                <div className="absolute bottom-0 left-0 ">
                    <button className="blueDiv text-white font-semibold bg-[#30407B] py-6 pl-12 text-[27px] w-[127%] text-start">
                        We Provide <br />
                        Professional<br />
                        Services.
                    </button>
