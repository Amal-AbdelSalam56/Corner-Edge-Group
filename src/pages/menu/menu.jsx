        ...
        <>
            ...
            <div className="Welcome flex bg-white text-[#37393F] p-8 flex-wrap">
                ...
                <div className="Left w-1/2 pr-4 py-36 px-14">
                    <p className="text-lg font-bold mb-4 flex">
                        <span>
                            <img src={Boxgreen} style={{ height: "fit-content", marginRight: "10px", marginTop: "10px" }} />
                        </span>
                        Welcome  to Corner Edge Group
                    </p>
                    <h1 className="text-4xl font-bold mb-4">With over 30 years of combined experience:</h1>
                    ...
                    <button className="bg-[#29366E] text-white px-5 py-4 mt-8"
